                    ...
                    <div className="relative flex flex-col gap-16 max-w-4xl mx-auto px-4">
                        ...
                        {timelineSteps.map((step, i) => (
                            <div key={i} className="flex flex-row items-center w-full relative group">
                                <div className={`absolute left-0 md:left-1/2 -ml-8 md:-ml-16 w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white shadow-lg overflow-hidden z-10 bg-gray-100 flex items-center justify-center transition-all duration-500 ease-in-out ${step.side === 'left' ? 'md:group-hover:w-80 md:group-hover:h-80 md:group-hover:ml-8 md:group-hover:shadow-2xl md:group-hover:z-30' : 'md:group-hover:w-80 md:group-hover:h-80 md:group-hover:-ml-[22rem] md:group-hover:shadow-2xl md:group-hover:z-30'} group-hover:border-clover-primary`}>
